...
<html lang="en">
  ...
  <body data-theme="light">
            ...
            <div class="card fade-in">
              ...
              >
                <div style="display: flex; gap: 8px; align-items: center">
                  ...
                  <button class="btn" id="sortSold">Sort Sold</button>
                </div>
                <div style="display: flex; gap: 8px; align-items: center">
              ...
              <table class="table">
                ...
                <tbody id="productsTable">
                  <tr
                    class="product-row"
                    style="border-bottom: solid rgb(114, 110, 110)"
                  >
                  ...
                  >
                    <td style="display: flex; gap: 10px; align-items: center">
                      <div>
                        <strong>Ice Coffee Latte</strong>
                        <div style="font-size: 12px; color: var(--muted)">
                          Coffee
                        </div>
                      </div>
                  ...
                  >
                    <td style="display: flex; gap: 10px; align-items: center">
                      <div>
                        <strong>Fruit Soda</strong>
                        <div style="font-size: 12px; color: var(--muted)">
                          Non-Coffee
                        </div>
                      </div>
                    </td>
                    <td><span id="sold"> 30 </span></td>
                    <td>
                      <span class="count"> 12 </span>
                      <button class="addBtn">
                        <i class="fa-solid fa-plus"> </i>
    ...
    <script>
      ...
      subtract.forEach(function (btn) {
        btn.onclick = function () {
          const td = btn.parentElement;
          const count = td.querySelector(".count");
          const soldCount = td.querySelector(".sold");
          count.textContent = Number(count.textContent) - 1;
