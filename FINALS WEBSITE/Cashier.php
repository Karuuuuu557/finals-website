<?php
// ─── AUTH GUARD ───────────────────────────────────────────
// Uncomment these lines once login is set up:
...
<body>
  ...
  <div class="main">
    ...
    <div class="order-panel">
      ...
      <div class="order-summary">
        ...
        <div class="summary-row"><span>Tax</span><span id="taxVal">₱0</span></div>
  ...
  <script>
    ...
    function updateSummary() {
      ...
      document.getElementById('taxVal').textContent = `₱0`;
      document.getElementById('totalVal').textContent = `₱${sub - disc}`;
      if (disc > 0) {
