...
<html lang="en">
  ...
  <body>
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-role"><?php echo htmlspecialchars(strtoupper($roles)); ?></div>
      <div class="nav-links">
        ...
        <div class="profile-card">
          ...
          <div class="profile-stat-row">
            ...
            <div class="profile-stat">
              ...
              <span class="profile-stat-value" style="color: var(--green)"
                >● Active</span
              >
            </div>
          </div>
    ...
    <script>
      ...
      function checkStrength() {
        ...
        const levels = [
          ...
          { w: "50%", color: "#b87333", label: "Fair" },
          { w: "75%", color: "#8c7a20", label: "Good" },
          { w: "100%", color: "#3a7d54", label: "Strong" },
        ];
